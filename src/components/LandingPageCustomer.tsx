...
const title = "AHR Members Page";
const sub = "Welcome To The AHR Family!";
            ...
            <div className="container px-4 md:px-6">
              <div className="grid items-center gap-6 lg:grid-cols-[1fr_500px] lg:gap-2 xl:grid-cols-[1fr_550px]">
                ...
                <div>
                  ...
                  Our team of experts can guide you through the difficult process of managing your staff and HR needs. Save time and money by letting us handle the hard stuff!
                  </p>
                </div>
              </div>
            </div>
